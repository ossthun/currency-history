...
export default function StockPage() {
  ...
  async function fetchStockPrice() {
    ...
    try {
      ...
      const requestedDate = new Date(`${apiDate}T00:00:00Z`);
      ...
      if (!chart || chart.error) {
        throw new Error(
          chart?.error?.description || "No stock data found."
        );
      }
          ...
          <div style={styles.result}>
            ...
            {!result.exact && (
              <div style={styles.notice}>
                No trading data was found for the exact date.
                Showing the previous trading day instead.
              </div>
            )}
