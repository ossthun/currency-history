  ...
  return (
    <main style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.badge}>Home Financing</div>
        ...
        <div style={styles.result}>
          ...
          <div style={styles.details}>
            Loan amount: ${formatMoney(result.loanAmount)} · Total interest: $
        ...
        <div style={styles.footer}>
          ...
          constitute financial advice. Real mortgage costs may include taxes,
          insurance, fees, and other charges.
        </div>
      </div>
    </main>
  );
