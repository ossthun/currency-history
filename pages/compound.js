  ...
  return (
    <main style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.badge}>Investment Growth</div>

        <h1 style={styles.title}>Compound Interest</h1>

        <p style={styles.subtitle}>
          Estimate long-term portfolio growth with recurring investments.
        </p>
        ...
        <div style={styles.result}>
          ...
          <div style={styles.details}>
            Invested: ${formatMoney(result.invested)} · Gain: $
        ...
        <div style={styles.footer}>
          ...
          constitute financial advice. Future returns are not guaranteed.
        </div>
      </div>
    </main>
  );
